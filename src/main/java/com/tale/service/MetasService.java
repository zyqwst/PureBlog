...
public class MetasService {
    ...
    private List<Contents> getMetaContents(Metas m) {
        ...
        List<Long>  cidList  = relationships.stream().map(Relationships::getCid).collect(Collectors.toList());
     ...
     * @param mid
     */
    public void saveMeta(String type, String name, Long mid) {
        if (StringKit.isNotBlank(type) && StringKit.isNotBlank(name)) {
